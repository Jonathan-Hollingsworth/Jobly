...
router.get("/:username", ensureLoggedIn, async function (req, res, next) {
  try {
    ...
    throw new UnauthorizedError("Only admins and appropiate user can recieve this data")
  } catch (err) {
    return next(err);
  }
});
...
router.patch("/:username", ensureLoggedIn, async function (req, res, next) {
  try {
    ...
    throw new UnauthorizedError("Only admins and appropiate user can edit this user")
  } catch (err) {
    return next(err);
  }
});
...
router.delete("/:username", ensureLoggedIn, async function (req, res, next) {
  try {
    ...
    throw new UnauthorizedError("Only admins and appropiate user can delete this user")
  } catch (err) {
    return next(err);
  }
});
